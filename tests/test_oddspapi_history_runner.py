...
def test_discover_finished_big5_uses_minimal_fixture_contract_and_harvests_results(monkeypatch):
    calls=[]; cached=[]
    def fake_get(path,key,params=None):
        calls.append((path,params))
        return [
            {"fixtureId":"ok","statusId":2,"tournamentId":17,"startTime":"2026-01-03T15:00:00Z","participant1Name":"A","participant2Name":"B","participant1Score":2,"participant2Score":1},
            {"fixtureId":"live","statusId":1,"tournamentId":17,"participant1Score":1,"participant2Score":0},
            {"fixtureId":"noodds","statusId":2,"tournamentId":17,"startTime":"2026-01-04T15:00:00Z","participant1Name":"C","participant2Name":"D"},
            {"fixtureId":"other","statusId":2,"tournamentId":999,"participant1Score":3,"participant2Score":0},
        ]
