...
def probe():
    ...
    try:
        ...
        return {"provider":"pinnwire_demo_prematch","generated_at":now,"status":"OK" if events else "NO_EVENTS","events":len(events),"events_with_spreads":spreads,"provider_generated_at":payload.get("generated_at"),"samples":samples}
